...
const WEB_COMMAND_MAP: Record<string, WebCommandDescriptor> = {
  ...
  service_session_dashboard: { rpcMethod: "session/dashboard" },
  service_session_doctor: { rpcMethod: "session/doctor" },
  service_session_migrate_preview: { rpcMethod: "session/migratePreview" },
  service_session_migrate: { rpcMethod: "session/migrate" },
  service_session_export: { rpcMethod: "session/export" },
  service_session_repair: { rpcMethod: "session/repair" },
  service_session_backups: { rpcMethod: "session/backups" },
