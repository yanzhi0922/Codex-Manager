...
# 强制发布为 pre-release
pwsh -NoLogo -NoProfile -File scripts/rebuild.ps1 `
  -AllPlatforms -GitRef main -ReleaseTag v0.1.16-beta.1 -GithubToken <token> -Prerelease true
```
...
```powershell
pwsh -NoLogo -NoProfile -File scripts/bump-version.ps1 -Version 0.1.16
```
