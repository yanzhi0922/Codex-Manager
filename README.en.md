...
## Recent Changes
- Current latest version: `v0.1.17` (2026-04-02)
...
- The release path stays unified: the product version is now `0.1.17`, and the workspace, frontend package, Tauri desktop app, release-version checks, and README version notes are all kept in sync. See [CHANGELOG.md](CHANGELOG.md) for the full history.
